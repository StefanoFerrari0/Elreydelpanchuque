    ...
    <Layout description="Somos El rey del panchuque, nos dedicamos a vender panchuqueras y otras maquinas como wafleras y demás. ¡Pasá a ver nuestro catálogo!" title="El rey del panchuque" link="https://elreydelpanchuque.com">
      ...
      <section className={styles.product}>
        ...
        <div className={styles.btnContainer}>
          <Button link="/products" title="Ver más productos" style={styles.btn} />  
        </div>
      </section>

      <section className={styles.socialContainer} id="contacto">
        <h2 className={styles.title + " " + styles.socialTitle}>Redes sociales</h2>
        <h4 className={styles.subtitle}>¡Contactanos!</h4>
        <div className={styles.imgContainer}>
          <Image className={styles.img} src={SocialMedia} height={450} width={450} alt="Ilustración"/>
        </div>
...
export async function getStaticProps({ params }) {
 ...
 let mainProductID = ["60fe6592c89553a21e236285", "6117d66f0135150edcd0f4e5", "6117d6300135150edcd0f4e0"]
  ...
  var data = allData.data.filter(function(el) {
